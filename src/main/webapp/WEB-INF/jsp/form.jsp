...
<body>
	<form action="/category/add" method="post" id="add_category">
		<input type="text" name="categoryName" class="form-control"
			placeholder="새로운 카테고리"> <input type="hidden" name="_csrf"
			value="${_csrf.token}">
	...
	<form:form action="${actionUrl}" commandName="post"
		...
		<span id="back" class="btn btn-primary btn-lg btn-block" onclick="history.back();">돌아가기</span><br>
	</form:form>

	<p class="text-muted">
		Powered By <a href="http://millky.com">Hagami</a> | WYSIWYG Editor by
